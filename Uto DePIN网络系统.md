...
模式二.灵活流动性交易系统 (Flexible Liquidity Trading System, FLTS)(风险中)
运行原理：
...
卖出价格
[(对付储备金池÷全网用户持有流通数量包含LP池子里面代币)+LP流动性池价值÷2]-LP池子深度越高容差越低兑付能力越高=买出的价格]
...
5.容差设置:(模式一，模式二都可以选择设定容差)(模式三属于自动容差)
