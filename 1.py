...
total_transactions = 1000000000  # 总交易次数，为了演示，这里设置为100次
...
tokens_to_sell = Decimal('99.9999999999999999999999')  # 每次卖出的代币数量
...
for i in range(1, total_transactions + 1):
    ...
    if i % 100 == 0:
        ...
        if user_tokens >= tokens_to_sell:
            ...
            user_tokens -= tokens_to_sell  # 卖出99.9999枚代币
